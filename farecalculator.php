...
<input type="hidden" name="<?php echo $hidden_field_name; ?>" value="Y">
 ...
 <td>
<input type="text" name="<?php echo $data_field_name; ?>" value="<?php echo esc_attr( get_option('latitude') ); ?>" size="20">
 </td> </tr>
 <tr valign="top">
       <th scope="row">Longitude</th> 
 <td>
<input type="text" name="longitude" value="<?php echo esc_attr( get_option('longitude') ); ?>" size="20">
 </td> </tr>
<tr>
  <td></td>
<td>
...
$place= $_POST['fc_source'].'-'.$_POST['fc_destination'];
$wpdb->insert( $table_name, array( 'name' => $_POST['fc_name'],
 'sd' => $place ,
  'vehicle' => $_POST['fc_car'] ,
   'distance' => $_POST['fc_dist'] ,
  'price' => round($_POST['fc_price']),
     'address' => $_POST['fc_address'] ,
      'phone' => $_POST['fc_mob'] ,
       'email' => $_POST['fc_email'] ,
        'date_booked' => $_POST['fc_date'] 
         ) );
}
